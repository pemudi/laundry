            ...
            <table class="table table-striped">
                ...
                <tbody style="text-align:center;">
                    ...
                    while($dt_histori=mysqli_fetch_array($qry_transaksi)){
                        ...
                        ?>
                        <tr>              
                            <td><?=$dt_histori['nama']?></td><td><?=$dt_histori['tgl_ttransaksi']?></td><td><?=$dt_histori['batas_waktu']?></td><td><?=$dt_histori['tgl_bayar']?></td><td><?=$dt_histori['status']?></td><td><?=$dt_histori['dibayar']?></td> 
                        </tr>
                        <?php 
                    }
                    ?>
